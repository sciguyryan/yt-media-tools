...
class EvaluationContext:
    ...
    __slots__ = ("_collection_bindings", "_record")

    def __init__(self, record: dict[str, Any], collection_bindings: tuple[Any, ...] = ()) -> None:
        self._record = record
    ...
    def bind_collection_element(self, element: Any) -> EvaluationContext:
        ...
        return EvaluationContext(self._record, self._collection_bindings + (element,))
