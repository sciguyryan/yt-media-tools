...
- Complete the post-0.26.2 hardening programme in deliberate phases. The dead-code and stale-state sweep is implemented in 0.26.3 and the systematic safe-optimiser audit in 0.26.4; next perform the exhaustive completeness review and brutal torture suite before considering more language syntax.
