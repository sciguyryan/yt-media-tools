...
- Freeze new syntactic sugar now that the `OF` source/facet series is complete. Do not add further grammar features until the post-0.26.2 completeness review has finished.
