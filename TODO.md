...
- Add hexadecimal, octal and binary integer literals in the next scalar-language dot release, including mixed-base arithmetic and exhaustive parser, semantic, optimiser and conformance coverage. Decide digit-separator syntax explicitly rather than introducing it accidentally.
