...
The longer-term programmes are documented under `docs/`, with active Discover version-series plans under `docs/roadmap/`. Completed Discover series are retained in release history and durable architecture documentation rather than the active roadmap directory. Discover 0.29.x completed the language and parser architecture programme; the active Discover roadmap now resumes broader language and utility work in 0.30.x. Downloader 1.19.1 contains the current machine-interface foundation.
