...
JOINs remain deliberately unsupported. Discover is not intended to become a general relational database engine. Multi-source work should continue to use sources, facets, CTEs and set composition.
